            ...
            switch (option) {
                case 1:
                    try {
                        ...
                        stmt.executeUpdate("INSERT INTO smartphones( `imei`, `brand`, `model`, `price`) " +
                ...
                case 2:
                    ...
                    try {
                        Connection c = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/smartphonedb?autoReconnect=true&useSSL=false", "root", "");
                        Statement stmt = c.createStatement();
                        ResultSet rs = stmt.executeQuery("SELECT `imei`, `brand`, `model`, `price` FROM `smartphones` WHERE 1");
                        while (rs.next()) {
                ...
                case 3:
                    try {
                        ...
                        Connection c = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/smartphonedb?autoReconnect=true&useSSL=false", "root", "");
                        Statement stmt = c.createStatement();
                        ResultSet rs = stmt.executeQuery("SELECT * FROM `smartphones` WHERE `brand` = '" + brand + "'");
                        while (rs.next()) {
                            System.out.println("Imei = " + rs.getInt("imei"));
                            System.out.println("model = " + rs.getString("model"));
                            System.out.println("price = " + rs.getInt("price"));
                ...
                case 4:
                    try {
                        ...
                        Connection c = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/smartphonedb?autoReconnect=true&useSSL=false", "root", "");
                        Statement stmt = c.createStatement();
                        stmt.executeUpdate("UPDATE `smartphones` SET `brand`='" + brand + "',`model`='" + model + "',`price`= " + price + " WHERE `imei` =" + imei);
                ...
                case 5:
                    try {
                        ...
                        Connection c = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/smartphonedb?autoReconnect=true&useSSL=false", "root", "");
                        Statement stmt = c.createStatement();
                        stmt.executeUpdate("DELETE FROM `smartphones` WHERE `imei`=" + imei);
